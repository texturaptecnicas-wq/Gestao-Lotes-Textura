    ...
    import { Package, Plus, Search, QrCode, Truck, Building, CalendarCheck, CheckCircle, Info, LogOut, DollarSign, Ruler, FileText, FilterX, Loader } from 'lucide-react';
    ...
    const InitialLoadingSpinner = () => (
      <div className="flex flex-col items-center justify-center text-center p-12 glass-effect rounded-2xl">
        <Loader className="w-16 h-16 animate-spin text-sky-400 mb-4" />
        <h3 className="text-2xl font-bold text-slate-200">Carregando lotes...</h3>
        <p className="text-slate-400">Buscando dados em tempo real.</p>
      </div>
    );
