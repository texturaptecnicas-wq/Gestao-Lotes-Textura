      ...
      >
        ...
        <div className="border-t border-slate-700/60 p-2">
          <div className="flex gap-2">
            ...
            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => onEdit(lote)} className="p-2.5 glass-effect hover:bg-slate-700/60 rounded-xl transition-all flex-shrink-0" aria-label="Editar Lote"><Edit className="w-4 h-4 text-sky-300" /></motion.button>
