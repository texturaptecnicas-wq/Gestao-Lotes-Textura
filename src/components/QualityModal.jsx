  ...
  return (
    <AnimatePresence>
      <motion.div 
        ...
        exit={{ opacity: 0 }} 
        onClick={onClose} 
        className={`fixed inset-0 z-[100] flex items-center justify-center ${isFullscreen ? 'p-0' : 'p-4 bg-black/70 backdrop-blur-sm'}`}
      >
        <motion.div 
          ref={elementRef} 
        ...
        >
          ...
          <div className="flex-grow overflow-hidden relative">
             <AnimatePresence mode="wait">
               {activeTab === 'alertas' && (
                 <motion.div key="tab-alertas" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="absolute inset-0 flex flex-col md:flex-row overflow-hidden">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          {!previewUrl ? (
                            ...
                            <div className="relative rounded-xl border border-slate-700 overflow-hidden bg-slate-950">
                    ...
                    <div className="w-full md:w-2/3 p-6 overflow-y-auto custom-scrollbar">
                      ...
                      {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-40 text-slate-500 bg-slate-900/50 rounded-xl border border-slate-800 border-dashed">
               ...
               {activeTab === 'diario' && (
                 <motion.div key="tab-diario" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.98 }} className="absolute inset-0 p-6 overflow-hidden">
                    <QualityDailyLog userRole={userRole} />
                 </motion.div>
               )}
               
               {activeTab === 'relatorios' && (
                 <motion.div key="tab-relatorios" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="absolute inset-0 overflow-hidden">
                    <QualityReports />
                 </motion.div>
               )}
             </AnimatePresence>
